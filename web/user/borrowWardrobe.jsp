    ...
    <script language="javascript" for="window" event="onload">
        function MakeForm() {
            ...
            if (flag) {
                ...
                form1.method = "POST";
                // form 提交路径
                form1.action = "/WardrobeBorrowServlet_user";
                // 对该 form 执行提交
                form1.submit();
                // 删除该 form
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">衣柜借用</a>
                </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            %>
                                            <button class="btn btn-primary btn-fill " onclick="change(<%=wardrobeList.get(i).getState().equals("0")%>,<%=wardrobeList.get(i).getId()%>)"><%=text%></button>
                                        </td>
                                    </tr>
                                    <%
                                            }
...
<script>
    function change(state,id) {
        layer.confirm('确认归还衣柜吗？', function (index) {
            ...
            // 设置相应参数
            input0.type = "text";
            input0.name = "wardrobeId";
            input0.value = id;
            input1.type = "text";
            input1.name = "wardrobeState";
            input1.value = state;
            // 将该输入框插入到 form 中
            ...
            form1.method = "POST";
            // form 提交路径
            form1.action = "/BorrowWardrobeServlet_user";
            // 对该 form 执行提交
            form1.submit();
            // 删除该 form
            document.body.removeChild(form1);
