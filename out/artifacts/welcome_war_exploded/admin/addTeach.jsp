        ...
        function checkFlag() {
            ...
            if(state){
                ...
                if(flag){
                    ...
                    layer.msg('该教练已存在!', {icon: 2, time: 2000});
                    return false;
                }
            }
        }
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div style="padding-left: 20px;padding-right: 20px">
                <form action="/AddTeachServlet_admin" method="post" id="add">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>编号</label>
                                <input type="text" class="form-control border-input" placeholder="Your Name" id="id" name="id">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>姓名</label>
                                <input type="text" class="form-control border-input" placeholder="Your Name" id="name" name="name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>所授课程</label>
                                <select type="text" class="form-control border-input" placeholder="Your ClassName"
                                        id="cid" name="cid">
                                    <option value="1">杠铃</option>
                                    <option value="2">跑步</option>
                                    <option value="3">瑜伽</option>
                                    <option value="4">健美操</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>联系电话</label>
                                <input type="text" class="form-control border-input" placeholder="Your Phone" id="tel" name="tel">
                            </div>
                        </div>
                    </div>
