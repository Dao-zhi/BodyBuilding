    ...
    <script language="javascript" for="window" event="onload">
        function MakeForm() {
            ...
            if (flag) {
                ...
                form1.method = "POST";
                // form 提交路径
                form1.action = "/UserListServlet_admin";
                // 对该 form 执行提交
                form1.submit();
                // 删除该 form
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary btn-fill "
                                                    onclick="reset(<%=userList.get(i).getuId()%>)">重置密码
                                            </button>
                                            <button class="btn btn-danger btn-fill "
                                                    onclick="del(<%=userList.get(i).getuId()%>)">删除
                                            </button>
                                        </td>
                                    </tr>
                                    <%
...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确认要删除这位学员吗？', function (index) {
            ...
            form1.method = "POST";
            // form 提交路径
            form1.action = "/DelUserServlet_admin";
            // 对该 form 执行提交
            form1.submit();
            // 删除该 form
            document.body.removeChild(form1);
    ...
    function reset(id) {
        layer.confirm('确认要重置密码？', function (index) {
            ...
            form1.method = "POST";
            // form 提交路径
            form1.action = "/ResetUserPwdServlet_admin";
            // 对该 form 执行提交
            form1.submit();
            // 删除该 form
            document.body.removeChild(form1);
