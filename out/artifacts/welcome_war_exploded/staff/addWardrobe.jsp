        ...
        function checkFlag() {
            ...
            if(state){
                ...
                if(flag){
                    ...
                    layer.msg('衣柜编号已存在!', {icon: 2, time: 2000});
                    return false;
                }
            }
        }
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div style="padding-left: 20px;padding-right: 20px">
                <form action="/AddWardrobeServlet_staff" method="post" name="add" id="add">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>衣柜编号</label>
                                <input type="text" class="form-control border-input" placeholder="id" id="id" name="id">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-info btn-fill btn-wd" onclick="update()">增加衣柜</button>
                    </div>
