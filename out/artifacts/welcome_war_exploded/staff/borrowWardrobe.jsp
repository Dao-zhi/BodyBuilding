...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content"><div style="padding-left: 20px;padding-right: 20px">
            <form action="/BorrowWardrobeServlet_staff" method="post" id="borrow">
                <div class="row">
                    <div class="col-md-3">
                ...
                <%String wardrobeId=request.getParameter("wardrobeId");%>
                <input type="hidden" value="<%=wardrobeId%>" id="wardrobeId" name="wardrobeId">
                <div class="text-center">
                    <button type="button" class="btn btn-info btn-fill btn-wd" onclick="update()">借用衣柜</button>
                </div>
